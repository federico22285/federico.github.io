...
```text
  Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nemo fugit unde repudiandae soluta voluptates in necessitatibus, quod laudantium impedit sapiente!
```
...
more about [snippet highlighting](https://support.codebasehq.com/articles/tips-tricks/syntax-highlighting-in-markdown)
#### Definition Lists
